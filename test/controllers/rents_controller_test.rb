...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { address: @rent.address, fullname: @rent.fullname, micropost_id: @rent.micropost_id, tel: @rent.tel, user_id: @rent.user_id } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { address: @rent.address, fullname: @rent.fullname, micropost_id: @rent.micropost_id, tel: @rent.tel, user_id: @rent.user_id } }
